...
| `sold_quantity_reconciliation` | FAIL-assert | run-516 | 302 | flow — scrolls My Shop for a QA Disposable title, the same shape as mark_sold_all_units, and should get the same search_my_shop conversion. NOT converted yet because it had not run in the in-flight seller pass. | [Failed] sold_quantity_reconciliation (4m 46s) (Assertion is false: id: listing-form-quantity-reopen-note is v |
