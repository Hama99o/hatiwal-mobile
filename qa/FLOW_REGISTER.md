...
| `lifecycle_from_chat` | PASS | run-523 | 353 | REGRESSION vs run-523 — passed there, fails here on `"View Listing" is visible`. Not obviously related to any change made in this campaign; needs its own read from run-526's artifacts before anything is done to it. |  |
