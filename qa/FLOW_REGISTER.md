...
| `mark_sold_all_units` | FAIL-? | run-522 | 248 | flow/fixture — "QA Disposable quantity_all" not visible, kind=unknown on a DISPOSABLE fixture. Verify it was seeded for this pass before treating it as UI. | [Failed] mark_sold_all_units (3m 35s) (No visible element found: "QA Disposable quantity_all") |
...
| `multi_quantity_offplatform_sale` | FAIL-? | run-522 | 303 | flow/fixture — "QA Disposable offplatform_units" not visible, kind=unknown on a DISPOSABLE fixture. Verify seeding for this pass before treating it as UI. Third disposable-fixture failure this cycle alongside conversation_delete and mark_sold_all_units — worth checking the disposable seeder as a group. | [Failed] multi_quantity_offplatform_sale (4m 16s) (No visible element found: "QA Disposable offplatform_units" |
